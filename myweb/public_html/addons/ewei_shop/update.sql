...
INSERT INTO `ims_modules` (`mid`, `name`, `type`, `title`, `version`, `ability`, `description`, `author`, `url`, `settings`, `subscribes`, `handles`, `isrulefields`, `issystem`, `issolution`, `target`, `iscard`) VALUES
(195, 'ewei_shop', 'business', '人人商城(分销)', '4.0', '人人商城(分销)', '人人商城(分销)，多项信息模板，强大的自定义规格设置,更新QQ:229364369', '梦小生', 'http://www.yofosky.com', 0, 'a:0:{}', 'a:1:{i:0;s:4:"text";}', 0, 0, 0, 0, 0);

INSERT INTO `ims_modules_bindings` (`eid`, `module`, `entry`, `call`, `title`, `do`, `state`, `direct`) VALUES
(914, 'ewei_shop', 'cover', '', '商城入口', 'shop', '', 0);
(915, 'ewei_shop', 'cover', '', '订单入口', 'order', '', 0),
(916, 'ewei_shop', 'cover', '', '购物车入口', 'cart', '', 0),
(917, 'ewei_shop', 'cover', '', '我的收藏入口', 'favorite', '', 0),
(918, 'ewei_shop', 'cover', '', '会员中心入口', 'member', '', 0),
(919, 'ewei_shop', 'menu', '', '商城管理', 'shop', '', 0),
(920, 'ewei_shop', 'menu', '', '会员管理', 'member', '', 0),
(921, 'ewei_shop', 'menu', '', '订单管理', 'order', '', 0),
(922, 'ewei_shop', 'menu', '', '数据统计', 'statistics', '', 0),
(923, 'ewei_shop', 'menu', '', '插件中心', 'plugins', '', 0),
(924, 'ewei_shop', 'menu', '', '系统设置', 'sysset', '', 0);

INSERT INTO `ims_ewei_shop_plugin` (`id`, `displayorder`, `identity`, `name`, `version`, `author`) VALUES
(1,	1,	'qiniu',	'七牛存储',	'1.0',	'官方'),
(2,	2,	'taobao',	'淘宝助手',	'1.0',	'官方'),
(3,	3,	'commission',	'分销系统',	'1.0',	'官方'),
(4,	4,	'poster',	'超级海报',	'1.2',	'官方'),
(5,	5,	'verify',	'O2O核销',	'1.0',	'官方');
